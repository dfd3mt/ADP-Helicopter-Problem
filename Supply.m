%make this a function that takes in params and outputs variables
...
CapRem=4000;    %4000*rand(AvailBH,1);   %Weight Capacity Remaining in lbs
...
InFlight=0;  %randsample([0,1],AvailBH,true);    %Indicator for whether or not the bird is inflight
